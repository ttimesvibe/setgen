...
## 썸네일 규칙
- 2~3줄, 총 글자수 12자 이하 권장 (모바일 150x150에서도 읽혀야 함)
- 제목과 같은 단어/정보를 반복하지 말 것 (1+1=3 원칙)
- 효과적 요소: 구체적 숫자, 대비 구조, 게스트의 인상적 발언 인용
- 썸네일이 "감정적 반응"을 유발하고, 제목이 "맥락과 이유"를 제공하는 분업이 이상적

## 유튜브 제목 규칙
- 1줄, 40~60자
- 핵심 주제어를 앞 20자 안에 배치 (모바일에서 뒤가 잘림)
- (게스트명 직함) 형식으로 끝남
- 썸네일이 던진 훅에 대한 "답의 실마리"를 제공하되, 완전한 답은 주지 않음
